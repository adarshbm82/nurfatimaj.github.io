  ...
  \resumeSubHeadingListStart
    ...
    \section*{Research}\subsection{Work in Progress}
      ...
      { \textbf{Fertility Choice and Intelligence in Developed Countries} with mboldrin and 
      arustichini }
      {}
      {}    \resumePublicationHeading
      ...
      {}
      {}    \resumePublicationHeading
      { \textbf{Intelligence and Tertiary Education} with ldimbou,
      aichino,
      jlreuter,
      arustichini,
      pvisscher and 
      ...
      {}
      {}    \resumePublicationHeading
      { \textbf{Multiple Imputation of University Degree Attainment} with jlreuter }
      {}
      {}\resumeSubHeadingListEnd
