  ...
  \resumeSubHeadingListStart
    ...
    \section*{Research}\subsection{Work in Progress}
      ...
      { \textbf{Does intelligence shield from negative family shocks?} with Jandarova }
      {}
      {}    \resumePublicationHeading
      { \textbf{Genetic Endowment and Sorting into University Education} with Jandarova, \href{http://www.andreaichino.it}{Ichino}, \href{https://sites.google.com/site/aldorustichini/}{Rustichini}, Reuter, \href{https://sites.google.com/site/giuliozanella/}{Zanella} }
      {}
      {}    \resumePublicationHeading
      { \textbf{Unemployment and educational choices} with Jandarova }
      {}
      {}\resumeSubHeadingListEnd
